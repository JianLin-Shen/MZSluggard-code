 ...
 */
public class CodeStyleProcessor extends AbstractLayoutCodeProcessor {
    ...
    public CodeStyleProcessor(Project project, PsiFile file, boolean processChangedTextOnly) {
